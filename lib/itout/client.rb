...
module ITout
  ...
  class Client
    include ITout::API::Channel
    include ITout::API::Conversation
    include ITout::API::Hashtags
    include ITout::API::Me
    include ITout::API::Search
    include ITout::API::Streams
    include ITout::API::Touts
    include ITout::API::Users
    include ITout::OAuth
